...
export class AlmacenesService {
  ...
  getDepartamentos(): Observable<ApiResponse> {
    ...
    return this.http.post<ApiResponse>(`${this.apiUrl}/GetAlmacen`, requestBody);
  }

// Método para insertar un nuevo departamento
insertarDepartamento(departamentoData: { Nombre: string; Direccion: string; UsuarioActualiza: number }): Observable<ApiResponse> {
